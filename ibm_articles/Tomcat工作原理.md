...
[原文链接](https://developer.ibm.com/zh/articles/j-lo-tomcat1/)
...
![图 1.Tomcat 的总体](../ibm_articles_img/j-lo-tomcat1_images_image001.gif)
...
![图 2. Service 接口](../ibm_articles_img/j-lo-tomcat1_images_image002.png)
...
![图 3. StandardService 的类结构图](../ibm_articles_img/j-lo-tomcat1_images_image003.png)
...
![图 4. Server 的类结构图](../ibm_articles_img/j-lo-tomcat1_images_image004.png)
...
![图 5. Lifecycle 类结构图](../ibm_articles_img/j-lo-tomcat1_images_image005.png)
...
![图 6. Connector 处理一次请求顺序图](../ibm_articles_img/j-lo-tomcat1_images_image006.png)
...
![图 7. Connector 的主要类图](../ibm_articles_img/j-lo-tomcat1_images_image007.png)
...
![图 8. 四个容器的关系图](../ibm_articles_img/j-lo-tomcat1_images_image008.png)
...
![图 9. Engine 和 Host 处理请求的时序图](../ibm_articles_img/j-lo-tomcat1_images_image009.png)
...
![图 10. Context 和 wrapper 的处理请求时序图](../ibm_articles_img/j-lo-tomcat1_images_image010.png)
...
![图 11. Engine 接口的类结构](../ibm_articles_img/j-lo-tomcat1_images_image011.png)
...
![图 12. Host 相关的类图](../ibm_articles_img/j-lo-tomcat1_images_image012.png)
...
![图 13. ServletConfig 与 StandardWrapperFacade、StandardWrapper 的关系](../ibm_articles_img/j-lo-tomcat1_images_image013.png)
